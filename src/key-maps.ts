...
const RAW_KEY_MAP: { keys: string[]; result: string | [string, string] }[] = [
  ...
  { keys: ['shift', 'leftshift', 'shiftleft'], result: ['Shift', 'Left Shift'] },
  { keys: ['rightshift', 'shiftright'], result: 'Right Shift' },
  { keys: ['ctrl', 'control', 'leftctrl', 'ctrlleft', 'leftcontrol', 'controlleft'], result: ['Ctrl', 'Left Control'] },
  {
    keys: ['rightctrl', 'ctrlright', 'rightcontrol', 'controlright'],
    result: ['Right Ctrl', 'Right Control'],
  },
  { keys: ['cmd', 'command'], result: ['Cmd', 'Command'] },
  { keys: ['option', 'opt'], result: ['Opt', 'Option'] },
  { keys: ['alt', 'leftalt', 'altleft'], result: ['Alt', 'Left Alt'] },
